...
class RetailerDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(user.shopName, style: GoogleFonts.poppins(fontWeight: FontWeight.bold))),
      body: ListView(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(user.shopName, style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 16)),
          ...
          if (user.gstNumber != null && user.gstNumber!.isNotEmpty)
            _Section(title: 'GST', child: _KV('GST Number', user.gstNumber!)),
          _Section(
            title: 'Business Hours',
            child: _KV('Open', hours == null || hours.is24x7 ? 'Open 24x7' : '${hours.openTime} – ${hours.closeTime}'),
          ),
          if (bank != null)
            _Section(
              title: 'Bank Details',
          ...
          _Section(title: 'Registered On', child: _KV('Date', formatOrderDateTime(user.createdAt))),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(title, style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 13, color: AppColors.primary)),
          const SizedBox(height: 8),
          child,
        ],
      ),
