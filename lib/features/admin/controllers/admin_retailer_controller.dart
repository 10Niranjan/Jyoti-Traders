...
final retailerSummariesProvider =
    Provider.autoDispose<AsyncValue<List<RetailerSummary>>>((ref) {
          ...
          data: (orders) {
            final summaries =
                users.map((user) {
                  ...
                  final totalSpend = userOrders.fold(
                    Money.zero,
                  ...
                  (a, b) => b.totalSpend.amount.compareTo(a.totalSpend.amount),
                );
