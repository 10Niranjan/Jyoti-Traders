...
Widget _wrap(FakeOrderRepository repo, {String orderId = 'o1'}) => ProviderScope(
...
void main() {
  ...
  testWidgets('changing the status dropdown calls the repository and confirms via snackbar', (tester) async {
