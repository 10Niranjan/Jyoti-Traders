...
void main() {
  ...
  test(
    're-saving the same street/city/pincode updates the label in place, not a duplicate',
    () {
  ...
  test(
    'a genuinely different address is appended alongside the existing one',
    () {
      final existing = [shop.copyWith(id: 'addr-1', label: 'Shop')];
      const warehouse = AddressEntity(
