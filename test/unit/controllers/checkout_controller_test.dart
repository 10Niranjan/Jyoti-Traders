...
void main() {
  ...
  test(
    'below the ₹2,500 minimum: neither places the order nor clears the cart',
    () async {
  ...
  test(
    'at or above the ₹2,500 minimum: places the order and clears the cart',
    () async {
  ...
  test(
    'a repository failure surfaces as AsyncError without clearing the cart',
    () async {
      when(
